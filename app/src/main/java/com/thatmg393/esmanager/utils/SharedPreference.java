...
public class SharedPreference {
	...
	private SharedPreference() throws GeneralSecurityException, IOException {
		...
		this.preferenceDataStore = new EncryptedPreferenceDataStore(EncryptedSharedPreferences.create(ActivityUtils.getInstance().getRegisteredActivity(), GlobalConstants.getInstance().getPreferenceName(), mk, EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV, EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM));
